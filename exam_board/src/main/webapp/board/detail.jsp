	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content rounded-5 shadow">
	      <div class="modal-header p-5 pb-4 border-bottom-0">
	        <h2 class="fw-bold mb-0">Detail Page</h2>
	      </div>
	
	      <div class="modal-body p-5 pt-0">
	          <div class="form-floating mb-3">
	            <input type="text" class="form-control rounded-4" id="floatingInput" placeholder="Title" readonly="readonly" value="${bvo.title }">
	            <label for="floatingInput">Title</label>
	          </div>
	          <div class="form-floating mb-3">
	            <input type="text" class="form-control rounded-4" id="floatingInput" placeholder="View" readonly="readonly" value="${bvo.point }">
	            <label for="floatingInput">View</label>
	          </div>
	          <div class="form-floating mb-3">
	            <input type="text" class="form-control rounded-4" id="floatingInput" placeholder="Reg_Date" readonly="readonly" value="${bvo.reg_date }">
	            <label for="floatingInput">Reg_Date</label>
	          </div>
	          <div class="form-floating mb-3">
	            <input type="text" class="form-control rounded-4" id="floatingPassword" placeholder="Writer" readonly="readonly" value="${bvo.writer }">
	            <label for="floatingInput">Writer</label>
	          </div>
			<div class="input-group">
				<textarea class="form-control" aria-label="With textarea" name="content" placeholder="Content" readonly="readonly">${bvo.content }</textarea>
			</div>
	          <hr class="my-4">
	          <a href="/brd/modify?bno=${bvo.bno }"><button class="w-45 mb-2 btn btn-lg rounded-4 btn-primary">Modify</button></a>
	          <a href="/brd/remove?bno=${bvo.bno }"><button class="w-45 mb-2 btn btn-lg rounded-4 btn-primary">Delete</button></a>
	      </div>
	    </div>
	  </div>
	</div>
