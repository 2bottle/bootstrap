	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content rounded-5 shadow">
	      <div class="modal-header p-5 pb-4 border-bottom-0">
	        <h2 class="fw-bold mb-0">Modify Page</h2>
	      </div>
	
	      <div class="modal-body p-5 pt-0">
	      <form action="">
	          <div class="form-floating mb-3">
	            <input type="text" class="form-control rounded-4" id="floatingInput" placeholder="Title" value="${bvo.title }">
	            <label for="floatingInput">Title</label>
	          </div>
	          <div class="form-floating mb-3">
	            <input type="text" class="form-control rounded-4" id="floatingPassword" placeholder="Writer" value="${ses.nick_name }" readonly="readonly">
	            <label for="floatingInput">Writer</label>
	          </div>
			<div class="input-group">
				<textarea class="form-control" aria-label="With textarea" name="content" placeholder="Content">${bvo.content }</textarea>
			</div>
	          <hr class="my-4">
